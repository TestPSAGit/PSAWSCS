...
public class ProductPage {
    ...
    static Boolean GetTheEstmationPopupTitle(WebDriver driver) {
        WaitS.WaitForElementToBeVisible(driver, "//div[@class='MobileRecoveryAndFinanceBlock']");
        driver.findElement(By.xpath("//div[@class='MobileRecoveryAndFinanceBlock']")).click();
