...
public class PreProdHomePageComponentsPeugeotBelgiumFRTest {
    ...
    public void BeforeTest() {
        ...
        driver.get("https://E562418:Id133499@be-store-preprod.peugeot.com/fr/Accueil");
    ...
    public void TheTextUnderThePageTitleIsCorrect() {
        assert (hp.CheckTextUnderTitlePresent(driver).equals("RECHERCHE ET ACHAT EN LIGNE DE VOITURES PEUGEOT NEUVES"));
    }

    @Test(priority = 8)

    public void GotToHomePageWhenClickingOnThePeugeotLogo() {
        assert (hp.CheckClickOnHeaderPeugeotLogo(driver).contains("http://be.store.peugeot.preprod.inetpsa.com"));
    }
