...
public class PreProdHomePageComponentsPeugeotBelgiumNLTest {
    ...
    public void BeforeTest() {
        ...
        driver.get("http://E562418:Id133499@be.store.peugeot.preprod.inetpsa.com/nl/Home");
    ...
    public void GotToHomePageWhenClickingOnThePeugeotLogo() {
        assert (hp.CheckClickOnHeaderPeugeotLogo(driver).contains("http://be.store.peugeot.preprod.inetpsa.com/nl/Home"));
    }
